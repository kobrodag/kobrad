...
import (
	...
	"github.com/kobradag/kobrad/domain/consensusreference"
	"github.com/kobradag/kobrad/domain/miningmanager/model"
	...
	"github.com/kobradag/kobrad/domain/miningmanager"
...
func generateNewCoinbase(addressPrefix util.Bech32Prefix, op opType) (*externalapi.DomainCoinbaseData, error) {
	...
	_, publicKey, err := libkobrawallet.CreateKeyPair(op == opECDSA)
	if err != nil {
		return nil, err
	}
	var address string
