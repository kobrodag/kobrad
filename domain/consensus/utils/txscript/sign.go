...
// SignatureScript creates an input signature script for tx to spend KODA sent
...
// SignatureScriptECDSA creates an input signature script for tx to spend KODA sent
