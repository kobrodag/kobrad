/*
Package txscript implements the kobra transaction script language.

This package provides data structures and functions to parse and execute
kobra transaction scripts.
...
Typical kobra scripts at the time of this writing are of several standard
...
what conditions must be met in order to spend kobra.
