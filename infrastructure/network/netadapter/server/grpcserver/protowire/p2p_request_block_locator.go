...
func (x *HarbidMessage_RequestBlockLocator) toAppMessage() (appmessage.Message, error) {
	if x == nil {
...
func (x *HarbidMessage_RequestBlockLocator) fromAppMessage(msgGetBlockLocator *appmessage.MsgRequestBlockLocator) error {
