...
func (x *HarbidMessage_Addresses) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "HarbidMessage_Addresses is nil")
	}
...
func (x *HarbidMessage_Addresses) fromAppMessage(msgAddresses *appmessage.MsgAddresses) error {
