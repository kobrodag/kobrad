...
// installService attempts to install the kobrad service. Typically this should
...
// removeService attempts to uninstall the kobrad service. Typically this should
...
// startService attempts to Start the kobrad service.
