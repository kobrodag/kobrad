...
import (
	...
	"github.com/kobradag/kobrad/stability-tests/common/mine"
...
func setupSyncee() (*rpc.Client, func(), error) {
	...
	synceeDataDir, err := useDirOrCreateTemp(activeConfig().SynceeDataDirectory, "syncee-kobrad-data-dir")
	if err != nil {
		return nil, nil, err
	}
...
func setupSyncer() (*rpc.Client, func(), error) {
	...
	syncerDataDir, err := useDirOrCreateTemp(activeConfig().SyncerDataDirectory, "syncer-kobrad-data-dir")
	if err != nil {
		return nil, nil, err
	}
