...
func TestVirtualSelectedParentBlueScoreAndVirtualDAAScore(t *testing.T) {
	...
	response, err := kobrad.rpcClient.GetVirtualSelectedParentBlueScore()
	if err != nil {
	...
	err = kobrad.rpcClient.RegisterForVirtualSelectedParentBlueScoreChangedNotifications(
	...
	err = kobrad.rpcClient.RegisterForVirtualDaaScoreChangedNotifications(
