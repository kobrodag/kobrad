...
// MsgIBDChainBlockLocator implements the Message interface and represents a kobra
...
// NewMsgIBDChainBlockLocator returns a new kobra locator message that conforms to
