...
// MsgRequestAddresses implements the Message interface and represents a kobra
...
// NewMsgRequestAddresses returns a new kobra RequestAddresses message that conforms to the
