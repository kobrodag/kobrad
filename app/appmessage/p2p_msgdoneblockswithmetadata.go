...
// MsgDoneBlocksWithTrustedData implements the Message interface and represents a kobra
...
// NewMsgDoneBlocksWithTrustedData returns a new kobra DoneBlocksWithTrustedData message that conforms to the
// Message interface.
