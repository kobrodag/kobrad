...
// MsgRequestTransactions implements the Message interface and represents a kobra
...
// NewMsgRequestTransactions returns a new kobra RequestTransactions message that conforms to
