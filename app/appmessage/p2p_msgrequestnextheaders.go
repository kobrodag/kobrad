...
// MsgRequestNextHeaders implements the Message interface and represents a kobra
...
// NewMsgRequestNextHeaders returns a new kobra RequestNextHeaders message that conforms to the
// Message interface.
