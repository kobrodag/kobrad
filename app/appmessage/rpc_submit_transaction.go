...
// RPCTransaction is a kobrad transaction representation meant to be
// used over RPC
...
// RPCTransactionInput is a kobrad transaction input representation
...
// RPCScriptPublicKey is a kobrad ScriptPublicKey representation
type RPCScriptPublicKey struct {
	Version uint16
	Script  string
}

// RPCTransactionOutput is a kobrad transaction output representation
// meant to be used over RPC
...
// RPCOutpoint is a kobrad outpoint representation meant to be used
// over RPC
...
// RPCUTXOEntry is a kobrad utxo entry representation meant to be used
// over RPC
