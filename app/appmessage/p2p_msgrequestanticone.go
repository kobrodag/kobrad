...
// MsgRequestAnticone implements the Message interface and represents a kobra
...
// NewMsgRequestAnticone returns a new kobra RequestPastDiff message that conforms to the
