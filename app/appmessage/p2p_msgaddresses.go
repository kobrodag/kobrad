...
// kobra Addresses message (MsgAddresses).
const MaxAddressesPerMsg = 1000

// MsgAddresses implements the Message interface and represents a kobra
// Addresses message.
...
// NewMsgAddresses returns a new kobra Addresses message that conforms to the
