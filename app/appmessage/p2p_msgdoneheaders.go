...
// MsgDoneHeaders implements the Message interface and represents a kobra
...
// NewMsgDoneHeaders returns a new kobra DoneIBDBlocks message that conforms to the
// Message interface.
