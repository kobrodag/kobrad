...
// MsgTransactionNotFound defines a kobra TransactionNotFound message which is sent in response to
...
// NewMsgTransactionNotFound returns a new kobra transactionsnotfound message that conforms to the
