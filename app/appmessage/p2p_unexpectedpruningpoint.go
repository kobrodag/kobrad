...
// MsgUnexpectedPruningPoint represents a kobra UnexpectedPruningPoint message
...
// NewMsgUnexpectedPruningPoint returns a new kobra UnexpectedPruningPoint message
