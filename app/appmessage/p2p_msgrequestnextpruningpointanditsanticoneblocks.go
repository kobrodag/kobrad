...
// MsgRequestNextPruningPointAndItsAnticoneBlocks implements the Message interface and represents a kobra
...
// NewMsgRequestNextPruningPointAndItsAnticoneBlocks returns a new kobra RequestNextPruningPointAndItsAnticoneBlocks message that conforms to the
// Message interface.
