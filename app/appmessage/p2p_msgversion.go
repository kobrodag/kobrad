...
var DefaultUserAgent = fmt.Sprintf("/kobrad:%s/", version.Version())

// MsgVersion implements the Message interface and represents a kobra version
...
// NewMsgVersion returns a new kobra version message that conforms to the
