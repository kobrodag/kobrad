...
// MsgRequestHeaders implements the Message interface and represents a kobra
...
// NewMsgRequstHeaders returns a new kobra RequestHeaders message that conforms to the
