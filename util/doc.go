/*
Package util provides kobra-specific convenience functions and types.

# Block Overview

A Block defines a kobra block that provides easier and more efficient
...
A Tx defines a kobra transaction that provides more efficient manipulation of
...
The Address interface provides an abstraction for a kobra address. While the
most common type is a pay-to-pubkey, kobra already supports others and
...
To decode/encode an address:
	...
	addrString := "kobra:qqj9fg59mptxkr9j0y53j5mwurcmda5mtza9n6v9pm9uj8h0wgk6uma5pvumr"
